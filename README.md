...
| Create         | 新增行為                                                                                                               |
| List (By)      | 清單列表，僅回傳部分識別性資料，By 後面接的名稱（或方法內參數名稱）描述主要的過濾條件，描述的過濾條件必須是名詞。      |
| Get (By)       | 取得一筆或多筆資料，By 後面接的名稱（或方法內參數名稱）描述主要的過濾條件，描述的過濾條件必須是名詞。                  |
| GetXWithY (By) | 取得完整的 X 合併一部分的 Y，回傳 X，By 後面接的名稱（或方法內參數名稱）描述主要的過濾條件，描述的過濾條件必須是名詞。 |
| GetXOfY (By)   | 取得完整的 X 合併一部分的 Y，回傳 Y，By 後面接的名稱（或方法內參數名稱）描述主要的過濾條件，描述的過濾條件必須是名詞。 |
| Save           | 儲存檔案及更新資料表行為                                                                                               |
| Remove         | 移除行為                                                                                                               |
